...
sentences = "জীবনে আছে কি?চারদিকে শুধু ই অন্ধকার ।কিছু নেই এই সমাজে "
tokenizer = TokenizeSentence('bengali')
bengali_text_tokenise =tokenizer.tokenize(sentences)
print(bengali_text_tokenise)
filltered=[]
...
for i in bengali_text_tokenise:
